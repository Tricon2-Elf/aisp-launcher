...
docker run --rm \
    ...
    bash -lc "set -euo pipefail \
        ...
        && i686-w64-mingw32-g++ -shared -O2 -s -std=gnu++17 -fno-exceptions -fno-rtti -static-libgcc -static-libstdc++ $SOURCE_DIR_IN_CONTAINER/*.cpp -o \"$OUTPUT_IN_CONTAINER\" -loleaut32 -lgdi32 -lole32 -lwinhttp \
