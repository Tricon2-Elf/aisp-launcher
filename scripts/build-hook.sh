...
# ws2_32 is for browser.cpp's loopback sockets.
HOOK_SOURCES="$SOURCE_DIR_IN_CONTAINER/aisp.hook.cpp $SOURCE_DIR_IN_CONTAINER/browser.cpp $SOURCE_DIR_IN_CONTAINER/screen.cpp $SOURCE_DIR_IN_CONTAINER/source.cpp $SOURCE_DIR_IN_CONTAINER/source_electron.cpp $SOURCE_DIR_IN_CONTAINER/source_ffmpeg.cpp $SOURCE_DIR_IN_CONTAINER/source_pattern.cpp $SOURCE_DIR_IN_CONTAINER/tv_panel.cpp $SOURCE_DIR_IN_CONTAINER/https.cpp $SOURCE_DIR_IN_CONTAINER/config.cpp $SOURCE_DIR_IN_CONTAINER/document.cpp $SOURCE_DIR_IN_CONTAINER/ytdlp.cpp $SOURCE_DIR_IN_CONTAINER/page_state.cpp $SOURCE_DIR_IN_CONTAINER/reload_notify.cpp"
